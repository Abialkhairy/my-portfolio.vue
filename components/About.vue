      ...
      <div class="flex flex-wrap">
        <div class="w-full px-4 mb-10 lg:w-1/2">
          ...
          <h2 class="font-bold text-dark text-3xl mb-3 max-w-md lg:text-4xl">
            Yuk belajar bahasa arab disini!
          </h2>
          <p class="font-medium text-base text-secondary max-w-xl lg:text-lg">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse
            voluptate voluptatibus quod quam laborum id sit.
          </p>
        </div>
        <div class="w-full px-4 lg:w-1/2">
          ...
          <p class="font-medium text-base text-secondary mb-6 lg:text-lg">
            ...
            Exercitationem odio sunt architecto quam incidunt velit rerum nihil
            quos.
          </p>
          <div class="flex items-center">
            ...
            <!-- Instagram -->
            <a
              href="https://instagram.com/abi_alkhairy"
              target="_blank"
              class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
            >
              <svg
            ...
            <!-- Twitter -->
            <a
              href="https://twitter.com/@abialkhairy"
              target="_blank"
              class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
            >
              <svg
